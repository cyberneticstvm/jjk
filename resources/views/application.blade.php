        ...
        <div class="mx-auto max-w-5xl">
            ...
            <form action="{{ route('application.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
                ...
                <fieldset class="card !p-6 sm:!p-9">
                    <legend class="px-2 font-serif text-3xl font-semibold text-forest">Retreat details</legend>
                ...
                <div class="rounded-3xl bg-forest p-6 text-white sm:flex sm:items-center sm:justify-between sm:p-8">
                    ...
                    <button type="submit" class="btn-primary mt-5 !bg-saffron hover:!bg-maroon sm:mt-0">Submit application</button>
                </div>
            </form>
        </div>
    </div>
