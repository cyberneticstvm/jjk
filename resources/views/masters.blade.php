...
@include('partials.page-hero',[
    ...
    'image'=>'images/vedanta-study.png',
    'alt'=>'A Vedanta teacher with students'
])

<section class="py-24">
    <div class="container-site">
        <article class="reveal grid overflow-hidden rounded-[2rem] bg-forest text-white lg:grid-cols-[.85fr_1.15fr]">
            <img src="{{ asset('images/vedanta-study.png') }}" alt="Traditional Vedanta teacher with students" class="h-full min-h-[520px] w-full object-cover">
            <div class="p-8 sm:p-12">
                <div class="text-xs font-bold uppercase tracking-[.2em] text-gold">Swami Tattvarupananda Saraswati</div>
                <h2 class="mt-3 text-4xl font-semibold sm:text-5xl">Swami Tattvarupananda Saraswati</h2>
                <div class="mt-6 space-y-4 leading-8 text-white/75">
